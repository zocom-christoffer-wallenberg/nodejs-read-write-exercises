...
4. Skriv ett program som läser in användarens input och sparar detta i en textfil. När användaren skrivit *exit* ska det inte gå att skriva till textfilen mera. Använd dig av **process.openStdin** och **createWriteStream**.